...
const modalCode = {
  ...
  type: [
    `<!-- Default Modal -->`,
    `// ...`,
    `<Btn onClick={() => toggleLayerVisible('modal1')} text="Centered Modal" />`,
    `<Modal ...>`,
    `// ...`,
    `</Modal>`,
    ``,
  ...
  size: [
    `<!-- Small Size Modal -->`,
    `// ...`,
    `<Btn onClick={() => toggleLayerVisible('modal5')} text="Centered Modal" />`,
    `<Modal ... size="sm">`,
    `// ...`,
    `</Modal>`,
    ``,
    ...
    `<!-- Large Size Modal -->`,
    `// ...`,
    `<Btn onClick={() => toggleLayerVisible('modal6')} text="Centered Modal" />`,
    `<Modal ... size="lg">`,
    `// ...`,
    `</Modal>`,
  ].join('\n'),
